...
func (h *campaignHandler) GetCampaign(c *gin.Context) {
	...
	response := helper.APIResponse("Success to get detail of campaign", http.StatusOK, "success", campaign.FormatDetailCampaign(detailCampaign))
	c.JSON(http.StatusOK, response)
}
...
func (h *campaignHandler) UploadImage(c *gin.Context) {
	...
	response := helper.APIResponse("Campaign image uploaded successfuly", http.StatusOK, "success", data)
	c.JSON(http.StatusOK, response)
}
